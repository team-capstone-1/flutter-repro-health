class AppoinmentModels {
  ...
  factory AppoinmentModels.fromJson(Map<String, dynamic> json) =>
      AppoinmentModels(
        message: json["message"],
        response: json["response"] == null
            ? []
            : List<ResponseDataAppointment>.from(json["response"]!
                .map((x) => ResponseDataAppointment.fromJson(x))),
      );
...
class ResponseDataAppointment {
  ...
  factory ResponseDataAppointment.fromJson(Map<String, dynamic> json) =>
      ResponseDataAppointment(
        id: json["id"],
