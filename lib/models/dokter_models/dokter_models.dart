class DokterModels {
  ...
  factory DokterModels.fromJson(Map<String, dynamic> json) => DokterModels(
...
class ResponseData {
  ...
  factory ResponseData.fromJson(Map<String, dynamic> json) => ResponseData(
        ...
        workHistories: json["work_histories"] == null
            ...
            : List<WorkHistory>.from(
                json["work_histories"]!.map((x) => WorkHistory.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "work_histories": workHistories == null
            ? []
            : List<dynamic>.from(workHistories!.map((x) => x.toJson())),
