...
class KandunganPage extends StatefulWidget {
  const KandunganPage({Key? key}) : super(key: key);

  @override
  State<KandunganPage> createState() => _KandunganPageState();
}

class _KandunganPageState extends State<KandunganPage> {
...
// Search Data Dokter Kandungan
  ...
  void navigateToPageInterMedika(int index) {
    List<Widget> pages = [
                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        onTap: () {
                          navigateToPageInterMedika(index);
                        },
                        child: Padding(
