...
void initState() {
  ...
  Widget build(BuildContext context) {
    final notificationLength = Provider.of<GetNotificationViewModel>(context, listen: false).notificationList?.response?.length;
                  ...
                  Center(
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (notificationData?.category == Category.INFO && notificationData?.category != null) {
                          return ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4,),
                              Text( notificationData?.date != null
                                ? DateFormat('dd MMMM yyyy', "id").format(notificationData!.date!)
                                : 'No date available',
